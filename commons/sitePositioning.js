...
export const HOME_SEO = Object.freeze({
  fr: Object.freeze({
    ...
    description:
      "Consultant externe, produit et développeur senior au Québec, Canada. Vision produit, architecture technique et développement sur mesure pour équipes en croissance : APIs, systèmes découpés, Laravel, WordPress headless quand l'édition à l'échelle le justifie, React/Vue. 20+ ans. Mandat externe récurrent (forfait), profil freelance ou pigiste senior dans la durée. Montréal et à distance.",
  }),
  en: Object.freeze({
    jobTitle: "External consultant & Product Engineer",
    description:
      "External consultant & Product Engineer in Quebec, Canada. Architecture for growth-stage teams: APIs, decoupled systems, Laravel, WordPress headless when editorial scale demands it, React/Vue. 20+ years. Recurring retainer, senior freelancer or contractor profile over time. Montreal & remote.",
  }),
});
