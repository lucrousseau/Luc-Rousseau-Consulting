...
/**
 * Scoped weekly impact claimed for a fractional cadence (days of focused CDI-equivalent
 * progress per week). At 3 d/wk this reaches full-week scoped parity (5); below that it
 * stays intentionally below parity so 1–2 d/wk are not sold as a 5 d/wk substitute.
 */
 ...
 * Example at 3 d/wk: 5 / 3 ≈ 1.7 (nearly “1 day worth 2”).
 */
