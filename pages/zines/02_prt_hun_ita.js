...
export default function Zine({ images }) {
  const { t } = useTranslation(["common", "zines", "zine-02-prt-hun-ita"]);

  return (
    <>
      <SEO
        title={t("zine-02-prt-hun-ita:zine-seo-title")}
        description={t("zine-02-prt-hun-ita:zine-seo-description")}
        ...
        <Container tag={"carousel"}>
          <Row
            ...
            columns={[
              {
                cols: { col: 4, lg: 12 },
                content: parse(t("zine-02-prt-hun-ita:content")),
              },
              {
                cols: { col: 8, lg: 12 },
