...
export default function Zine({ images }) {
  const { t } = useTranslation(["common", "zines", "zine-05-gre-esp-fra"]);

  return (
    <>
      <SEO
        title={t("zine-05-gre-esp-fra:zine-seo-title")}
        description={t("zine-05-gre-esp-fra:zine-seo-description")}
        ...
        <Container tag={"carousel"}>
          <Row
            ...
            columns={[
              {
                cols: { col: 4, lg: 12 },
                content: parse(t("zine-05-gre-esp-fra:content")),
              },
              {
                cols: { col: 8, lg: 12 },
